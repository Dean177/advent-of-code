...
let puzzle_input = In_channel.read_all "./day_08.txt" |> String.split ~on:'\n'

let parsed_string_length str =
  str

let %expect_test _ =
  puzzle_input |> List.map ~f: parsed_string_length |> List.iter ~f:print_endline;
  [%expect {|
